...
! function(a) {
    window.console = window.console || function() {
        ...
        return this.each(function() {
            ...
            function e(b, d) {
                ...
                if (c.showNav) {
                    ...
                    e += '<div class="gridder-navigation">', e += '<a href="#" class="gridder-nav prev ' + (g.length ? "" : "disabled") + '">' + c.prevText + "</a>", e += '<a href="#" class="gridder-close">' + c.closeText + "</a>", e += '<a href="#" class="gridder-nav next ' + (i.length ? "" : "disabled") + '">' + c.nextText + "</a>", e += "</div>"
                }
        ...
        showNav: !0,
        nextText: '<i class="fa fa-arrow-right fa-3x"></i>',
